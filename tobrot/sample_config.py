...
class Config(object):
    ...
    TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "1333135551:AAG3uOUTl6lmURMhQZ3cJUIhLe1PBt4Cf6M")
    # The Telegram API things
    APP_ID = int(os.environ.get("APP_ID", 1695325))
    API_HASH = os.environ.get("API_HASH" , "16dc6d1578130db531344b941306537e")
    OWNER_ID = int(os.environ.get("OWNER_ID", 712333877))
    # Get these values from my.telegram.org
    # to store the channel ID who are authorized to use the bot
    AUTH_CHANNEL = set(int(x) for x in os.environ.get("AUTH_CHANNEL", "-1001315959058").split())
